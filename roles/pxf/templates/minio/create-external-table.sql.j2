DROP EXTERNAL TABLE IF EXISTS read_pxf_parquet_s3;
CREATE EXTERNAL TABLE read_pxf_parquet_s3
(
    MONTH0 text,
    CUSTOMER_ID text,
    SERVICE text,
...
LOCATION ('pxf://jbucket01/part-m-00000.gz.parquet?PROFILE=s3:parquet&SERVER=default')
