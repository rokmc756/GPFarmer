...
{"location": "Los Angeles", "month": "Dec","num_orders": 0, "total_sales": 0.00, "items_sold": null}' > /tmp/sample-data-orc.json

java -jar orc-tools-1.8.3-uber.jar convert /tmp/sample-data-orc.json --schema 'struct<location:string,month:string,num_orders:int,total_sales:decimal(10,2),items_sold:array<string>>' -o /tmp/sample-data-orc.orc
# log4j:WARN No appenders could be found for logger (org.apache.hadoop.util.Shell).
# log4j:WARN Please initialize the log4j system properly.
# log4j:WARN See http://logging.apache.org/log4j/1.2/faq.html#noconfig for more info.
# Processing /tmp/sample-data-orc.json

hdfs dfs -put /tmp/sample-data-orc.orc /data/pxf_examples/orc_example
