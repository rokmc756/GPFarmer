...
do
    ...
    sudo rpm -e greenplum-db --allmatches; sudo rpm -e --allmatches greenplum-db-5; sudo rpm -e --allmatches greenplum-db-6; sudo rpm -e --allmatches greenplum-db-7; sudo rm -rf /home/gpadmin/greenplum*.zip /home/gpadmin/greenplum*.rpm /data/ /data/master /data/primary /data/mirror \
