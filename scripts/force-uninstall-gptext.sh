...
for i in `seq $RANGE`; do ssh gpadmin@192.168.0.$i sudo rm -rf /usr/local/greenplum-solr /usr/local/greenplum-text /usr/local/greenplum-text-3.* /data/master/zoo0 /home/gpadmin/greenplum-text-3.* /home/gpadmin/gptext*  ; done
