...
do
    ...
    echo "ssh $ROOT_USER@192.168.0.$i 'rm -rf /usr/local/greenplum-cc* /home/gpadmin/.pgpass /home/gpadmin/certs'"
    ssh $ROOT_USER@192.168.0.$i 'rm -rf /usr/local/greenplum-cc* /home/gpadmin/.pgpass /home/gpadmin/certs'
done
